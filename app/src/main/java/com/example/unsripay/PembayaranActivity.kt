...
// Apply animation and navigation to all buttons
        setButtonAnimation(findViewById(R.id.btn_ukt), ukt::class.java)
        setButtonAnimation(findViewById(R.id.btn_suliet), suliet::class.java)
        setButtonAnimation(findViewById(R.id.btn_yudisium), yudisium::class.java)
